...
export default function Bootcamp() {
  ...
  return (
    <>
      <Header />
      <div className="mt-16 bg-[#4AC8AE] h-40 lg:h-52">
      ...
      <div className="bg-white mt-[-142px]">
        <div className="pt-40">
          <ul className={`grid grid-cols-3 lg:flex md:flex md:gap-6 lg:gap-6 justify-center items-center font-Roboto font-bold text-md  lg:text-xl ${isScrolled ? 'fixed top-[70px] text-white bg-[#4AC8AE] px-4 py-2 w-full z-10 transition-all duration-1000' : ''}`}>
              ...
              <table className="table-auto w-full text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2">Pengembangan aplikasi web sederhana.</td>
                  </tr>
                  <tr>
