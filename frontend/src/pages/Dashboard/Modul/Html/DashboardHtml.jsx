...
const content = {
    ...
    rangkuman: "HTML adalah bahasa markah standar untuk membuat halaman web. Diciptakan pada awal tahun 1990-an oleh Tim Berners-Lee, HTML telah berkembang menjadi fondasi dari World Wide Web. HTML digunakan untuk menentukan struktur, menambahkan konten, dan membuat tautan dalam sebuah halaman web. Tag dan atribut HTML memberikan kerangka dasar untuk mengorganisir dan menyajikan konten."
};
...
export default function DashboardHtml() {
    ...
    return (
        <>
            <div className="w-full lg:w-[70%] mx-auto bg-white rounded-lg shadow-xl lg:p-8 mt-2 mb-10 pb-5">
                <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 text-center font-roboto">{content.judul}</h2>
                <div className="mb-4 p-2">
                    <p className="text-lg md:text-xl font-bold font-Roboto mb-4">{content.pengantar.title}</p>
                    <p className="px-4 text-base indent-4 md:text-lg text-gray-700 font-Roboto leading-relaxed md:leading-loose text-justify">{content.pengantar.text}</p>
                </div>
                <div className="mb-4 p-2">
                ...
                <div className="mb-4 p-2">
                    ...
                    <ul className="list-disc text-justify pl-6 font-Roboto text-base md:text-lg text-gray-700 hover:text-green-600 transition-colors duration-300">
                ...
                <div className="mb-4 p-2">
                    ...
                    <div className="bg-gray-100 rounded-md my-4 overflow-x-auto w-80 mx-auto md:w-full">
                        <pre className="p-4">
...
<body>
    ...
    <h1>Hello Word</h1>
                ...
                <div className='p-2 px-4'>
                    <h2 className="text-xl md:text-2xl lg:text-6xl font-bold mb-4 font-roboto">Rangkuman</h2>
                    <p className="text-base md:text-lg text-gray-700 font-Roboto leading-relaxed md:leading-loose text-justify indent-4">
                        {content.rangkuman}
                    </p>
                </div>
                <div className='my-4'>
                    <button
                        ...
                        className='ml-4 py-2 px-2 bg-green-800 rounded-lg text-white font-Roboto font-bold hover:bg-green-700'
                    >
                        Selanjutnya
                    </button>
                </div>
