        ...
        <>
            <div className="w-full lg:w-[70%] mx-auto bg-white rounded-lg shadow-xl lg:p-8 mt-2 mb-10 pb-5 overflow-hidden">
                ...
                <div className="mb-4 p-2">
                    ...
                    <ul className="px-4 list-disc text-justify pl-6 font-Roboto text-base md:text-lg text-gray-700">
                ...
                <div className="mb-4 p-2">
                    <p className="px-2 text-lg md:text-xl font-bold font-Roboto mb-4">{content.entity.title}</p>
                    <p className='px-4 text-justify text-md font-Roboto indent-4 mb-2'>{content.entity.points[0]}</p>
                    <ul className="px-4 ml-4 list-disc pl-6 font-Roboto text-base md:text-lg text-gray-700 hover:text-green-600 transition-colors duration-300">
