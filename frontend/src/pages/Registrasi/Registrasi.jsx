...
import { RiLockPasswordFill, RiEyeFill, RiEyeOffFill } from "react-icons/ri"; // Menambahkan ikon mata
...
export default function Registrasi() {
    ...
    return (
        <>
                    ...
                    <div className="container mx-auto">
                        <div className="flex flex-wrap">
                            <div className="hidden sm:block ml-28 md:ml-40">
                                <img src={ImgRegistrasi} className="lg:h-[567px] md:h-[450px] lg:my-10" alt="login-img" />
                            </div>
                                ...
                                <div className="relative mt-2 lg:ml-44">
                                    <div className="rounded-lg bg-white dark:border-2 dark:border-blue-800 dark:bg-gradient-to-bl from-gray-800 via-blue-900 to-gray-800 shadow-md p-4">
                                        <div className="ml-4 mt-2 ">
                                            <h2 className="font-Roboto font-bold text-2xl md:text-4xl text-black dark:text-white">Daftar</h2>
                                        </div>
                                        ...
                                        <div className="relative mx-4 my-8">
                                            <input
                                                type={showPassword ? "text" : "password"} // Menggunakan ternary untuk menampilkan/menyembunyikan sandi
                                            ...
                                            <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                                                {showPassword ? (
                                                    <RiEyeOffFill className="text-xl cursor-pointer" onClick={togglePasswordVisibility} />
                                                ) : (
                                                    <RiEyeFill className="text-xl cursor-pointer" onClick={togglePasswordVisibility} />
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative mx-4 my-8">
                                            <input
                                                type={showConfirmPassword ? "text" : "password"} // Menggunakan ternary untuk menampilkan/menyembunyikan sandi
                                            ...
                                            <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                                                {showConfirmPassword ? (
                                                    <RiEyeOffFill className="text-xl cursor-pointer" onClick={toggleConfirmPasswordVisibility} />
                                                ) : (
                                                    <RiEyeFill className="text-xl cursor-pointer" onClick={toggleConfirmPasswordVisibility} />
                                                )}
                                            </div>
                                        </div>
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)} title="Notifikasi">
                {modalContent}
            </Modal>
        </>
    );
