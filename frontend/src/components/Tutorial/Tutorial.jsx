...
function Card({ image, title, description, link, onClick }) {
  return (
    <div
      className="max-w-xs sm:max-w-sm bg-white border-2 border-gray-200 rounded-lg shadow  dark:border-blue-900 dark:bg-gradient-to-bl from-gray-900 via-blue-950 to-gray-900 mt-8 cursor-pointer"
      onClick={onClick}
    >
      <img
...
export default function Tutorial() {
  ...
  const [cards] = useState([
    ...
    },
    {
      ...
      description:
        "Langkah-langkah lengkap untuk membuat landing page yang menarik menggunakan Flutter 1",
      videoUrl: "https://youtu.be/i0_ZjBYtsV0?si=hzLyd6JQzJ5CPGyQ",
      category: "android",
    },
    {
      image: FooterCover,
  ...
  return (
    <div className="bg-white dark:bg-gray-900 h-auto pb-10">
      <div ref={contentRef} className="mx-5 pt-10 mb-5 lg:mb-10">
        ...
        <p className="text-[#667085] dark:text-gray-400 text-[16px] lg:text-[20px] font-Roboto mb-8">
          Ikuti langkah-langkah praktis dari tutorial kami untuk menguasai
          berbagai teknologi pemrograman.
        </p>
      </div>
          ...
          <div className="flex flex-wrap justify-center space-x-2">
            <button
              ...
              className={`py-2 px-2 rounded text-sm ${
                category === "all"
                  ? "bg-[#20B486] text-white dark:bg-white dark:text-black"
          ...
          <div className="lg:col-span-3 md:col-span-2 mb-4">
            {playingIndex !== -1 && (
              <>
                ...
                >
                  <source
                    src={filteredCards[playingIndex].videoUrl}
                    type="video/mp4"
                  />
                </video>
                <div className="mt-4 p-4 bg-white shadow-xl dark:bg-gray-700 rounded-lg border-2  dark:border-blue-900 dark:bg-gradient-to-bl from-gray-900 via-blue-950 to-gray-900">
