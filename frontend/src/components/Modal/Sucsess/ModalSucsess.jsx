...
export default function ModalSuccses({ handleModul, setShowModal }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 sm:p-6">
      <div className="bg-white dark:bg-gradient-to-bl from-gray-800 via-blue-900 to-gray-800 dark:border-2 dark:border-blue-800 p-6 sm:p-8 rounded shadow-lg relative max-w-md w-full">
        ...
        <h2 className="text-lg sm:text-xl mb-2 sm:mb-4 text-center font-bold font-Roboto text-black dark:text-white">
          Selamat, Anda Telah Menyelesaikan Modul Ini!
        </h2>
        <p className="mb-4 text-sm sm:text-base text-center font-Roboto text-black dark:text-gray-200">
          Terima kasih telah menyelesaikan modul ini. Klik "OK" untuk
          melanjutkan ke dashboard modul berikutnya.
        </p>
