...
import Javascriptl from "./pages/Modul/JS/Javascript";
import Dart from "./pages/Modul/Dart/Dart";
...
//dashboard Modul Flutter
import DartCover from "./pages/Dashboard/Modul/Dart/DartCover/DartCover";
...
import BootcampFullStack from "./pages/Dashboard/Bootcamp/BootcampFullStack/BootcampFullStack";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/modul-javascript" element={<Javascriptl />} />
        <Route path="/modul-dart" element={<Dart />} />
        ...
        <Route path="/dashboard" element={<DashboardLayout />}>
          ...
          <Route path="modul/dart" element={<DartCover />} />
          <Route path="tutorial" element={<Tutorial />} />
          <Route path="bootcamp" element={<CoverBootcamp />} />
          <Route path="bootcamp/php" element={<DashboardPhp />} />
          <Route path="bootcamp/webdeveloper" element={<BootcampFullStack />} />
        </Route>
      </Routes>
    </Router>
  );
